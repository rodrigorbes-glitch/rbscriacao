  ...
  return (
    <div className="public-layout">
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2.5rem', alignItems: 'center' }}>
          
          {/* CONTATOS */}
          <div>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '1rem', color: 'var(--color-text-primary)' }}>Fale Conosco</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {configuracao?.telefone_publico && (
                <a
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--color-text-secondary)', textDecoration: 'none', fontSize: '0.9rem' }}
                >
              ...
              {configuracao?.instagram && (
                ...
                >
                  ...
                  @{configuracao.instagram.split('/').filter(Boolean).pop()}
                </a>
              )}
            </div>
          </div>
          ...
          <div style={{ textAlign: 'center', padding: '1.5rem', backgroundColor: 'var(--color-bg-primary)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-border)' }}>
            <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>🤝</div>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.5rem', color: 'var(--color-text-primary)' }}>Seja um Distribuidor</h3>
            <p style={{ fontSize: '0.875rem', color: 'var(--color-text-secondary)', marginBottom: '1rem' }}>Revenda nossos produtos e expanda seus negócios.</p>
            <button
